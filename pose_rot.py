...
# These should be determined via camera calibration
    ...
    for template, kp1, des1, label in templates:
        ...
        if len(good_matches) > max_matches and len(good_matches) > 15:
            ...
            if M is not None:
                ...
                _, rotations, translations, normals = cv2.decomposeHomographyMat(M, camera_matrix)
                ...
                # Display orientation and distance information
